...
const template = (context) => {
  return new Promise((resolve) => {
    resolve(html`
      <h5 class="card-title">Tell us how the patient feels.</h5>
      <div class="card-text">
        <form>
          <div class="form-group">
            <label for="input-feel">We will try to recognize the patient's symptoms using Natural Language Processing algorithms.</label>
            <textarea placeholder="e.g. the patient got headache" class="form-control" id="input-feel" rows="4"></textarea>
          </div>
        </form>
