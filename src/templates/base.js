...
const template = `
  <div class="card">
      <div class="card-header">
          <i class="fa fa-user-md"></i> Symptom Checker by Katalyst Medical<span class="d-none d-sm-block float-right text-muted">powered by <a href="http://katalystmed.com/">Katalyst Medical</a></span>
      </div>
